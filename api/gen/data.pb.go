...
const file_data_proto_rawDesc = "" +
	...
	"\bmetadata\x18\a \x01(\v2\x1d.lippycat.data.PacketMetadataR\bmetadata\"\x8a\x02\n" +
	...
	"\x03rtp\x18\b \x01(\v2\x1a.lippycat.data.RTPMetadataR\x03rtp\"\x99\x01\n" +
...
var file_data_proto_depIdxs = []int32{
	...
	0, // 5: lippycat.data.StreamControl.flow_control:type_name -> lippycat.data.FlowControl
	1, // 6: lippycat.data.DataService.StreamPackets:input_type -> lippycat.data.PacketBatch
	8, // 7: lippycat.data.DataService.SubscribePackets:input_type -> lippycat.data.SubscribeRequest
	7, // 8: lippycat.data.DataService.StreamPackets:output_type -> lippycat.data.StreamControl
	1, // 9: lippycat.data.DataService.SubscribePackets:output_type -> lippycat.data.PacketBatch
