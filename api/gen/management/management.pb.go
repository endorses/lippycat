...
type ProcessorHeartbeat struct {
	...
	SipRetry      *SIPRetryTelemetry   `protobuf:"bytes,6,opt,name=sip_retry,json=sipRetry,proto3" json:"sip_retry,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProcessorHeartbeat) GetSipRetry() *SIPRetryTelemetry {
	if x != nil {
		return x.SipRetry
	}
	return nil
...
func (x *ProcessorStats) GetSipRetry() *SIPRetryTelemetry {
	if x != nil {
		return x.SipRetry
	}
	return nil
...
type SIPRetryTelemetry struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	RetriesSeen      uint64                 `protobuf:"varint,1,opt,name=retries_seen,json=retriesSeen,proto3" json:"retries_seen,omitempty"`
	RecoveredCalls   uint64                 `protobuf:"varint,2,opt,name=recovered_calls,json=recoveredCalls,proto3" json:"recovered_calls,omitempty"`
	WindowExpiries   uint64                 `protobuf:"varint,3,opt,name=window_expiries,json=windowExpiries,proto3" json:"window_expiries,omitempty"`
	RejectedAttempts uint64                 `protobuf:"varint,4,opt,name=rejected_attempts,json=rejectedAttempts,proto3" json:"rejected_attempts,omitempty"`
	RejectedMedia    uint64                 `protobuf:"varint,5,opt,name=rejected_media,json=rejectedMedia,proto3" json:"rejected_media,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *SIPRetryTelemetry) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SIPRetryTelemetry) GetRetriesSeen() uint64 {
	if x != nil {
		return x.RetriesSeen
	}
	return 0
}

func (x *SIPRetryTelemetry) GetRecoveredCalls() uint64 {
	if x != nil {
		return x.RecoveredCalls
	}
	return 0
}

func (x *SIPRetryTelemetry) GetWindowExpiries() uint64 {
	if x != nil {
		return x.WindowExpiries
	}
	return 0
}

func (x *SIPRetryTelemetry) GetRejectedAttempts() uint64 {
	if x != nil {
		return x.RejectedAttempts
	}
	return 0
}

func (x *SIPRetryTelemetry) GetRejectedMedia() uint64 {
	if x != nil {
		return x.RejectedMedia
	}
	return 0
}
...
const file_management_proto_rawDesc = "" +
	...
	"pcapWriter\x12C\n" +
	"\tsip_retry\x18\x06 \x01(\v2&.lippycat.management.SIPRetryTelemetryR\bsipRetry\"Y\n" +
