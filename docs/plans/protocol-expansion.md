...
- [x] Documentation and usage examples (`docs/TLS_DECRYPTION.md`, `cmd/watch/README.md`)

**User documentation:** See [docs/TLS_DECRYPTION.md](../TLS_DECRYPTION.md) for CLI usage, key log generation, and troubleshooting.
