...
type SIPMetadata struct {
	...
	// 3GPP IMS P-Access-Network-Info header (3GPP TS 24.229)
	...
	// INVITE transaction identity. Zero/empty on older peers or malformed messages.
	CseqNumber uint64 `protobuf:"varint,14,opt,name=cseq_number,json=cseqNumber,proto3" json:"cseq_number,omitempty"`
	ViaBranch  string `protobuf:"bytes,15,opt,name=via_branch,json=viaBranch,proto3" json:"via_branch,omitempty"`
	// Bounded RTP media ports advertised by this SIP message's SDP.
	MediaPorts    []uint32 `protobuf:"varint,16,rep,packed,name=media_ports,json=mediaPorts,proto3" json:"media_ports,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SIPMetadata) GetAccessNetworkInfo() *AccessNetworkInfo {
	if x != nil {
		return x.AccessNetworkInfo
	}
	return nil
}
...
func (x *SIPMetadata) GetCseqNumber() uint64 {
	if x != nil {
		return x.CseqNumber
	}
	return 0
...
func (x *SIPMetadata) GetViaBranch() string {
	if x != nil {
		return x.ViaBranch
	}
	return ""
...
func (x *SIPMetadata) GetMediaPorts() []uint32 {
	if x != nil {
		return x.MediaPorts
	}
	return nil
...
// This provides access network information for VoLTE/VoWiFi sessions.
type AccessNetworkInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Access technology type (e.g., "IEEE-802.11", "3GPP-E-UTRAN", "3GPP-NR")
	AccessType string `protobuf:"bytes,1,opt,name=access_type,json=accessType,proto3" json:"access_type,omitempty"`
	// WiFi AP MAC address (from i-wlan-node-id parameter)
	Bssid string `protobuf:"bytes,2,opt,name=bssid,proto3" json:"bssid,omitempty"`
	// Cellular cell ID (from cgi-3gpp, utran-cell-id-3gpp, ecgi, ncgi parameters)
...
func (x *AccessNetworkInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AccessNetworkInfo) GetBssid() string {
	if x != nil {
		return x.Bssid
	}
	return ""
...
func (x *AccessNetworkInfo) GetCellId() string {
	if x != nil {
		return x.CellId
	}
	return ""
...
func (x *AccessNetworkInfo) GetLocalIp() string {
	if x != nil {
		return x.LocalIp
	}
	return ""
...
func (x *AccessNetworkInfo) GetParameters() map[string]string {
	if x != nil {
		return x.Parameters
	}
	return nil
...
type BatchStats struct {
	...
	// Named cumulative local loss stages. dropped remains their compatible sum.
...
func (x *BatchStats) GetCaptureBufferRegularDrops() uint64 {
	if x != nil {
...
func (x *BatchStats) GetCaptureBufferSipDrops() uint64 {
	if x != nil {
...
const file_data_proto_rawDesc = "" +
	...
	"cseqMethod\x12\x1f\n" +
	"\vcseq_number\x18\x0e \x01(\x04R\n" +
	"cseqNumber\x12\x1d\n" +
	"\n" +
	"via_branch\x18\x0f \x01(\tR\tviaBranch\x12\x1f\n" +
	"\vmedia_ports\x18\x10 \x03(\rR\n" +
	"mediaPorts\"\x8f\x02\n" +
	"\x11AccessNetworkInfo\x12\x1f\n" +
	"\vaccess_type\x18\x01 \x01(\tR\n" +
	"accessType\x12\x14\n" +
	"\x05bssid\x18\x02 \x01(\tR\x05bssid\x12\x17\n" +
	"\acell_id\x18\x03 \x01(\tR\x06cellId\x12\x19\n" +
	"\blocal_ip\x18\x04 \x01(\tR\alocalIp\x12P\n" +
	"\n" +
	"parameters\x18\x05 \x03(\v20.lippycat.data.AccessNetworkInfo.ParametersEntryR\n" +
	"parameters\x1a=\n" +
