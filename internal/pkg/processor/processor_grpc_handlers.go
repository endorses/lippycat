	...
	for _, h := range hunters {
		...
		connectedHunters = append(connectedHunters, &management.ConnectedHunter{
			...
			Stats: &management.HunterStats{
				...
				CaptureBufferRegularDrops:     h.CaptureBufferRegularDrops,
				CaptureBufferSipDrops:         h.CaptureBufferSIPDrops,
				CaptureBufferSipDemotions:     h.CaptureBufferSIPDemotions,
				BatchChannelDrops:             h.BatchChannelDrops,
				CaptureBufferRegularLen:       h.CaptureBufferRegularLen,
				CaptureBufferRegularCapacity:  h.CaptureBufferRegularCapacity,
				CaptureBufferSipLen:           h.CaptureBufferSIPLen,
				CaptureBufferSipCapacity:      h.CaptureBufferSIPCapacity,
				CaptureBufferOutputLen:        h.CaptureBufferOutputLen,
				CaptureBufferOutputCapacity:   h.CaptureBufferOutputCapacity,
				...
				RtpOwnershipUnresolved:        h.RTPOwnershipUnresolved,
				RtpOwnershipAmbiguous:         h.RTPOwnershipAmbiguous,
				IdentityInheritanceSuppressed: h.IdentityInheritanceSuppressed,
				Detector:                      h.Detector,
				CaptureLosses:                 h.CaptureLosses,
				AnalysisLosses:                h.AnalysisLosses,
				QueueLosses:                   h.QueueLosses,
				UnsupportedKindLosses:         h.UnsupportedKindLosses,
				TransportLosses:               h.TransportLosses,
			},
