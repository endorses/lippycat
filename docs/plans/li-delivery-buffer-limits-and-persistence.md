...
| Producers                | [processor_li.go](../../internal/pkg/processor/processor_li.go), synchronous send methods in `client.go`                                                                      | All producers need consistent queue policy; sync methods currently bypass queues and ordering.                                                                  |
