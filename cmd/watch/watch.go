...
func init() {
	...
	WatchCmd.PersistentFlags().String("offline-backing-policy", "source", "offline packet backing: source (keep inputs unchanged) or snapshot (validated private copies)")
