...
See the [identity contract](design/radius-identity-contract.md) for exact binary
rules and the [LI deployment guide](LI_INTEGRATION.md#radius-x1-authorization-and-nai-migration)
...
[raw RADIUS X2 delivery](LI_INTEGRATION.md#raw-radius-x2-delivery) for state ownership
and [the observation contract](design/radius-observation-contract.md) for association.
...
[LI delivery monitoring](LI_INTEGRATION.md) for the existing delivery statistics.
